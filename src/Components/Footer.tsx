import { chakra, Divider, Heading, Stack, Text, Link } from '@chakra-ui/react';
	...
	return(
		...
		>
			...
			<Stack direction={['column', 'row']} justify={'center'} align={['center', 'center']} wrap={'wrap'} spacing={['40px','60px']}>
				<Link as={RLink} target={'_blank'} to='https://www.behance.net/emmacreative'  _hover={{color:'#E54927'}} fontSize={['14px','14px']} color={'#fff'} textDecoration={'underline'}>BEHANCE</Link>
				<Link as={RLink}  target={'_blank'} to='https://www.instagram.com/_adeolus/'  _hover={{color:'#E54927'}} fontSize={['14px','14px']} color={'#fff'} textDecoration={'underline'}>INSTAGRAM</Link>
				<Link as={RLink} target={'_blank'} to='https://dribbble.com/emmacreative'  _hover={{color:'#E54927'}} fontSize={['14px','14px']} color={'#fff'} textDecoration={'underline'}>DRIBBLE</Link>
				<Link as={RLink} target={'_blank'} to='https://www.twitter.com/_adeolus/'  _hover={{color:'#E54927'}} fontSize={['14px','14px']} color={'#fff'} textDecoration={'underline'}>TWITTER</Link>
